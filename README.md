...
I'm a **Python / Django Full-Stack Developer** with a foundation built on **30 years of engineering discipline** — from managing water-supply automation systems, to programming Siemens PLCs in brick manufacturing, to automating master-data workflows with SQL and VBA in automotive production.

In 2024 I made a deliberate decision: **channel that engineering mindset into modern software development.** Since then, I've completed **12 professional certifications** at [SoftUni](https://softuni.bg), built production-ready Django applications, and I'm not stopping.

What sets me apart isn't just code — it's the **systematic thinking, high-responsibility decision-making, and relentless pursuit of quality** that come from decades of real-world engineering.
...
![Trophies](https://i.ytimg.com/vi/OulNMuJgha4/maxresdefault.jpg)
